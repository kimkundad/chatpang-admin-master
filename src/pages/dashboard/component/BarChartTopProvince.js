...
const BarChartTopProvince = (props) => {
    ...
    return (
        <ResponsiveBar
            ...
            tooltip={(props) => {
                ...
                >{props.indexValue} : {fcomma(props.value)}
                </div>
            }}
            ...
            //     >
            //         {/* <strong> */}
            //         {props.data.transportation_price} : <strong>{props.data?.transportation_price_item} </strong>
            //         {/* </strong> */}
            //     </div>
            // }}
            ...
            label={(d) => {
                ...
                return <tspan fill="white">{fcomma(d.value)}</tspan>
...
export default BarChartTopProvince;