        ...
        <ResponsiveBar
            ...
            tooltip={(props) => {
                ...
                >
                    ...
                    ค่าส่ง {fcomma(props.value)} บาท | พัสดุ {fcomma(props.data.order_item)} ชิ้น
                </div>
            }}
            ...
            label={(d) => {
                ...
                return <tspan fill="white">{`${fcomma(d.value)} (${fcomma(d.data.order_item)})`}</tspan>
...
export default BarChartTopSender;