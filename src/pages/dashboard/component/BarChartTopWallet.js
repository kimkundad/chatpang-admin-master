    ...
    return (
        <ResponsiveBar
            ...
            tooltip={(props) => {
                ...
                showVal = `${props.indexValue} : ยอดเติม : ${fcomma(props.data.amount)} | ยอดคงเหลือ : ${fcomma(props.data.total)}`
            ...
            label={(d) => {
                ...
                let showVal
                if (d.id == "amount_sub_total")
                    showVal = Math.round(d.data.amount)
                else
...
export default BarChartTopWallet;