...
const Map = (props) => {
  ...
  // const currentLat =
  //   hubId === 'create' ? 13.736717 : Number(LatLng?.lat || 13.0);
  // const currentLng =
  //   hubId === 'create' ? 100.523186 : Number(LatLng?.lng || 100.0);

  // const zoom = hubId === 'create' ? 5 : 16;
  ...
  if (actionPage === 'view' && hubId !== 'create') {
    return (
      <div>
