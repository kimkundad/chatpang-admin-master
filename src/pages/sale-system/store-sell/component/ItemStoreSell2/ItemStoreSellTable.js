...
const ItemStoreSellTable = (props) => {
    const {
        rowData,
        headerColumns,
        gridApi,
    ...
    const DoContent = (params) => {
        return <ItemCardView  setEditingDoNo={setEditingDoNo} setShowDoForm={setShowDoForm} itemStoreSell={params.data} params={params} />
    }
    ...
    return (
        <div className="ag-theme-balham site-drawer-render-in-current-wrapper" style={{ flex: 1 }}>
            ...
            >
                ...
                <AgGridColumn width={950} flex={1} field="rowNo" headerName="รายการพัสดุ" sortable={true} sort='desc' cellRenderer={"doContent"}></AgGridColumn>
...
export default ItemStoreSellTable;
